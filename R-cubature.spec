...
Version  : 2.0.4
Release  : 24
URL      : https://cran.r-project.org/src/contrib/cubature_2.0.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/cubature_2.0.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575562648
